...
export function Filter({ className = '', width = 20, height = 20 }: FilterProps) {
  return (
    <svg
      className={className}
      width={width}
    ...
    >
      ...
      />
      <path d='M1 3H9' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M13 3H17' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M1 9H3' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M1 15H12' stroke='currentColor' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
